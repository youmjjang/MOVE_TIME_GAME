...
const STAGES = {
  ...
  4:{name:"NARROW BEAT", intro:"넓어진 통로에서 적이 지나가는 타이밍을 보고 이동하세요.", time:30, step:18, worldTick:.13,
    start:{x:50,y:445}, exit:{x:890,y:50,w:28,h:72},
    walls:[WALL(130,190,28,350),WALL(265,0,28,280),WALL(400,260,28,280),WALL(535,0,28,280),WALL(670,260,28,280),WALL(805,0,28,280)],
    hazards:[CIRCLE(220,230,21,"y",90,470,1,145),CIRCLE(355,340,21,"y",90,470,-1,150),CIRCLE(490,230,21,"y",90,470,1,155),
             CIRCLE(625,340,21,"y",90,470,-1,160),CIRCLE(760,230,21,"y",90,470,1,165)]},
